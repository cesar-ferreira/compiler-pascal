...
public class PascalParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PascalGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFactorAccess().getGroup_7(), "rule__Factor__Group_7__0");
			...
			builder.put(grammarAccess.getFactorAccess().getNilAssignment_3(), "rule__Factor__NilAssignment_3");
			builder.put(grammarAccess.getFactorAccess().getBooleanAssignment_4(), "rule__Factor__BooleanAssignment_4");
			builder.put(grammarAccess.getFactorAccess().getBooleanAssignment_5(), "rule__Factor__BooleanAssignment_5");
			builder.put(grammarAccess.getFactorAccess().getFunctionAssignment_6(), "rule__Factor__FunctionAssignment_6");
			builder.put(grammarAccess.getFactorAccess().getExpressionAssignment_7_1(), "rule__Factor__ExpressionAssignment_7_1");
			builder.put(grammarAccess.getFactorAccess().getNotAssignment_8_1(), "rule__Factor__NotAssignment_8_1");
			...
			builder.put(grammarAccess.getStructured_statementAccess().getWithStmtAssignment_2(), "rule__Structured_statement__WithStmtAssignment_2");
			...
			builder.put(grammarAccess.getRepetitive_statementAccess().getRepeatStmtAssignment(), "rule__Repetitive_statement__RepeatStmtAssignment");
			...
			builder.put(grammarAccess.getUnpacked_structured_typeAccess().getSetAssignment_2(), "rule__Unpacked_structured_type__SetAssignment_2");
			builder.put(grammarAccess.getUnpacked_structured_typeAccess().getFileAssignment_3(), "rule__Unpacked_structured_type__FileAssignment_3");
