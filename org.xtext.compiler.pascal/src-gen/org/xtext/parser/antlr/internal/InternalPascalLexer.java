...
public class InternalPascalLexer extends Lexer {
    ...
    public final void mRULE_NUMERIC_SUBRANGE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5921:23: ( ( RULE_INTEGER_NUMBER | RULE_REAL_NUMBER | RULE_SIGNED_INTEGER_NUMBER | RULE_SIGNED_REAL_NUMBER ) '..' )
            // InternalPascal.g:5921:25: ( RULE_INTEGER_NUMBER | RULE_REAL_NUMBER | RULE_SIGNED_INTEGER_NUMBER | RULE_SIGNED_REAL_NUMBER ) '..'
            {
            // InternalPascal.g:5921:25: ( RULE_INTEGER_NUMBER | RULE_REAL_NUMBER | RULE_SIGNED_INTEGER_NUMBER | RULE_SIGNED_REAL_NUMBER )
            int alt1=4;
            ...
            switch (alt1) {
                case 1 :
                    // InternalPascal.g:5921:26: RULE_INTEGER_NUMBER
                    {
                    ...
                    break;
                case 2 :
                    // InternalPascal.g:5921:46: RULE_REAL_NUMBER
                    {
                    mRULE_REAL_NUMBER(); 
                    ...
                    break;
                case 3 :
                    // InternalPascal.g:5921:63: RULE_SIGNED_INTEGER_NUMBER
                    {
                    ...
                    break;
                case 4 :
                    // InternalPascal.g:5921:90: RULE_SIGNED_REAL_NUMBER
                    {
    ...
    public final void mRULE_ADDITION_OPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5923:24: ( ( '+' | '-' ) )
            // InternalPascal.g:5923:26: ( '+' | '-' )
            {
    ...
    public final void mRULE_MULTIPLICATION_OPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5925:30: ( ( '*' | '/' ) )
            // InternalPascal.g:5925:32: ( '*' | '/' )
            {
            if ( input.LA(1)=='*'||input.LA(1)=='/' ) {
                input.consume();
    ...
    public final void mRULE_RELATIONAL_OPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5927:26: ( ( '=' | '<>' | '<' | '<=' | '>' | '>=' ) )
            // InternalPascal.g:5927:28: ( '=' | '<>' | '<' | '<=' | '>' | '>=' )
            {
            // InternalPascal.g:5927:28: ( '=' | '<>' | '<' | '<=' | '>' | '>=' )
            int alt2=6;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_SIGNED_INTEGER_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5929:28: ( RULE_ADDITION_OPERATOR RULE_INTEGER_NUMBER )
            // InternalPascal.g:5929:30: RULE_ADDITION_OPERATOR RULE_INTEGER_NUMBER
            {
    ...
    public final void mRULE_INTEGER_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5931:21: ( RULE_UNSIGNED_DIGIT_SEQUENCE )
            // InternalPascal.g:5931:23: RULE_UNSIGNED_DIGIT_SEQUENCE
            {
    ...
    public final void mRULE_SIGNED_REAL_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5933:25: ( RULE_ADDITION_OPERATOR RULE_REAL_NUMBER )
            // InternalPascal.g:5933:27: RULE_ADDITION_OPERATOR RULE_REAL_NUMBER
            {
            mRULE_ADDITION_OPERATOR(); 
            mRULE_REAL_NUMBER(); 
    ...
    public final void mRULE_REAL_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5935:18: ( ( RULE_UNSIGNED_DIGIT_SEQUENCE '.' ( RULE_UNSIGNED_DIGIT_SEQUENCE )? ( ( 'E' | 'e' ) RULE_DIGIT_SEQUENCE )? | RULE_UNSIGNED_DIGIT_SEQUENCE ( 'E' | 'e' ) RULE_DIGIT_SEQUENCE ) )
            // InternalPascal.g:5935:20: ( RULE_UNSIGNED_DIGIT_SEQUENCE '.' ( RULE_UNSIGNED_DIGIT_SEQUENCE )? ( ( 'E' | 'e' ) RULE_DIGIT_SEQUENCE )? | RULE_UNSIGNED_DIGIT_SEQUENCE ( 'E' | 'e' ) RULE_DIGIT_SEQUENCE )
            {
            // InternalPascal.g:5935:20: ( RULE_UNSIGNED_DIGIT_SEQUENCE '.' ( RULE_UNSIGNED_DIGIT_SEQUENCE )? ( ( 'E' | 'e' ) RULE_DIGIT_SEQUENCE )? | RULE_UNSIGNED_DIGIT_SEQUENCE ( 'E' | 'e' ) RULE_DIGIT_SEQUENCE )
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalPascal.g:5935:21: RULE_UNSIGNED_DIGIT_SEQUENCE '.' ( RULE_UNSIGNED_DIGIT_SEQUENCE )? ( ( 'E' | 'e' ) RULE_DIGIT_SEQUENCE )?
                    {
                    mRULE_UNSIGNED_DIGIT_SEQUENCE(); 
                    match('.'); 
                    // InternalPascal.g:5935:54: ( RULE_UNSIGNED_DIGIT_SEQUENCE )?
                    int alt3=2;
                    ...
                    // InternalPascal.g:5935:84: ( ( 'E' | 'e' ) RULE_DIGIT_SEQUENCE )?
                    int alt4=2;
                    ...
                    switch (alt4) {
                        case 1 :
                            // InternalPascal.g:5935:85: ( 'E' | 'e' ) RULE_DIGIT_SEQUENCE
                            {
                    ...
                    break;
                case 2 :
                    // InternalPascal.g:5935:117: RULE_UNSIGNED_DIGIT_SEQUENCE ( 'E' | 'e' ) RULE_DIGIT_SEQUENCE
                    {
                    mRULE_UNSIGNED_DIGIT_SEQUENCE(); 
                    if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                        input.consume();
    ...
    public final void mRULE_UNSIGNED_DIGIT_SEQUENCE() throws RecognitionException {
        try {
            // InternalPascal.g:5937:39: ( ( RULE_DIGIT )+ )
            // InternalPascal.g:5937:41: ( RULE_DIGIT )+
            {
            // InternalPascal.g:5937:41: ( RULE_DIGIT )+
            int cnt6=0;
            loop6:
    ...
    public final void mRULE_DIGIT_SEQUENCE() throws RecognitionException {
        try {
            // InternalPascal.g:5939:30: ( ( RULE_ADDITION_OPERATOR )? RULE_UNSIGNED_DIGIT_SEQUENCE )
            // InternalPascal.g:5939:32: ( RULE_ADDITION_OPERATOR )? RULE_UNSIGNED_DIGIT_SEQUENCE
            {
            // InternalPascal.g:5939:32: ( RULE_ADDITION_OPERATOR )?
            int alt7=2;
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalPascal.g:5941:21: ( '0' .. '9' )
            // InternalPascal.g:5941:23: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5943:17: ( ( '(*' ( options {greedy=false; } : . )* '*)' | '{' ( options {greedy=false; } : . )* '}' ) )
            // InternalPascal.g:5943:19: ( '(*' ( options {greedy=false; } : . )* '*)' | '{' ( options {greedy=false; } : . )* '}' )
            {
            // InternalPascal.g:5943:19: ( '(*' ( options {greedy=false; } : . )* '*)' | '{' ( options {greedy=false; } : . )* '}' )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalPascal.g:5943:20: '(*' ( options {greedy=false; } : . )* '*)'
                    {
                    match("(*"); 

                    // InternalPascal.g:5943:25: ( options {greedy=false; } : . )*
                    loop8:
                    do {
                        int alt8=2;
                    ...
                    break;
                case 2 :
                    // InternalPascal.g:5943:62: '{' ( options {greedy=false; } : . )* '}'
                    {
                    match('{'); 
                    // InternalPascal.g:5943:66: ( options {greedy=false; } : . )*
                    loop9:
                    do {
                        int alt9=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5945:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalPascal.g:5945:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalPascal.g:5945:11: ( '^' )?
            int alt11=2;
            ...
            // InternalPascal.g:5945:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5947:10: ( ( '0' .. '9' )+ )
            // InternalPascal.g:5947:12: ( '0' .. '9' )+
            {
            // InternalPascal.g:5947:12: ( '0' .. '9' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5949:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalPascal.g:5949:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalPascal.g:5949:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // InternalPascal.g:5949:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalPascal.g:5949:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop14:
                    do {
                        int alt14=3;
                    ...
                    break;
                case 2 :
                    // InternalPascal.g:5949:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalPascal.g:5949:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop15:
                    do {
                        int alt15=3;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5951:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalPascal.g:5951:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalPascal.g:5951:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop17:
            do {
                int alt17=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5953:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalPascal.g:5953:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalPascal.g:5953:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt20=0;
            loop20:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:5955:16: ( . )
            // InternalPascal.g:5955:18: .
            {
            matchAny(); 
    ...
    class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "5921:25: ( RULE_INTEGER_NUMBER | RULE_REAL_NUMBER | RULE_SIGNED_INTEGER_NUMBER | RULE_SIGNED_REAL_NUMBER )";
        }
    }
    ...
    class DFA5 extends DFA {
        ...
        public String getDescription() {
            return "5935:20: ( RULE_UNSIGNED_DIGIT_SEQUENCE '.' ( RULE_UNSIGNED_DIGIT_SEQUENCE )? ( ( 'E' | 'e' ) RULE_DIGIT_SEQUENCE )? | RULE_UNSIGNED_DIGIT_SEQUENCE ( 'E' | 'e' ) RULE_DIGIT_SEQUENCE )";
        }
    }
